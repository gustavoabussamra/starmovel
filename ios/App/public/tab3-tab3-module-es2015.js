...
/* harmony import */ var _suporte_suporte_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../suporte/suporte.page */ "./src/app/suporte/suporte.page.ts");
...
let Tab3Page = class Tab3Page {
    constructor(menu, router, navController, alertController, modalController) {
        this.menu = menu;
        this.router = router;
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (config == "apn") {
                const alert = yield this.alertController.create({
                    ...
                    header: 'Descrição',
                    message: 'Sigla para Access Point Name (ponto de acesso). '
            ...
            if (config == "rede") {
                const alert = yield this.alertController.create({
                    cssClass: 'my-custom-class',
                    header: 'Descrição',
                    message: 'Você pode configurar seu aparelho para selecionar uma rede automaticamente, ' +
