(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppComponentesWaterWaterComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentesWaterWaterComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppComponentesWaterWaterComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_tab1_tab1_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/tab1/tab1.page */
      "./src/app/tab1/tab1.page.ts");

      var WaterComponent = /*#__PURE__*/function () {
        function WaterComponent(tab1Page) {
      ...
      WaterComponent.ctorParameters = function () {
        return [{
          type: src_app_tab1_tab1_page__WEBPACK_IMPORTED_MODULE_2__["Tab1Page"]
        }];
      };

      WaterComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ion-water',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./water.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/componentes/water/water.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./water.component.scss */
        "./src/app/componentes/water/water.component.scss"))["default"]]
      })], WaterComponent);
      /***/
    },
    ...
    function srcAppTab1Tab1ModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _componentes_water_water_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../componentes/water/water.component */
      "./src/app/componentes/water/water.component.ts");
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _pacote_pacote_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../pacote/pacote.page */
      ...
      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(menu, apiService, router, modalController, alertController, loadingController, toastController, navController) {
        ...
        _createClass(Tab1Page, [{
          ...
          key: "OpenExtrato",
          value: function OpenExtrato() {
            this.router.navigateByUrl("extrato");
          }
        }, {
          key: "OpenFatura",
          value: function OpenFatura() {
            this.router.navigateByUrl("fatura");
          }
        }, {
          key: "OpenChamado",
          value: function OpenChamado() {
            this.router.navigateByUrl("chamado");
          }
        }, {
          key: "OpenPacote",
          value: function OpenPacote() {
          ...
          key: "Saldo",
          value: function Saldo(plano, saldo) {
          ...
          value: function retornaDados() {
            ...
            this.apiService.retornaDados(localStorage.getItem('codCliente')).subscribe(function (data) {
              console.log(data);
              _this.nome = data[0].nome;
              _this.cpf = data[0].cpf;
              _this.contrato = data[0].numero_contrato;
              _this.simCard = data[0].num_card;
              _this.produto = data[0].produto;
              _this.status = data[0].status;
              _this.celular = data[0].nro_telefone;
              ...
              _this.apiService.Extrato('2000-01-01', '2000-01-01', data[0].numero_contrato).subscribe(function (data) {
                if (Number.isNaN(parseFloat((data.retorno.PlanoAtual_Gb - data.retorno.Saldo_Gb).toFixed(2))) == true) {
                  _this.saldo = '0';
                } else {
                  _this.saldo = (data.retorno.PlanoAtual_Gb - data.retorno.Saldo_Gb).toFixed(2);
                }

                if (data.retorno.PlanoAtual_Gb == null) {
                  _this.plano = '0';
                } else {
                  _this.plano = data.retorno.PlanoAtual_Gb;
                }

                _this.Saldo(data.retorno.PlanoAtual_Gb, data.retorno.Saldo_Gb);
              });
            });
          }
        }, {
          key: "AtivarChip",
          value: function AtivarChip() {
                              ...
                              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                while (1) {
                                  switch (_context3.prev = _context3.next) {
                                    case 0:
                                      this.presentLoading();
                                      this.apiService.AtivarSimCard(data.card).subscribe(function (data) {
                                        _this3.Load.dismiss();

                                        if (data.mensagem == 'SUCESSO') {
                                          _this3.Alert('Ativar Chip', data.mensagem);
          ...
          key: "Alert",
          value: function Alert(header, msg) {
